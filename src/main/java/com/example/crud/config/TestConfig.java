...
import com.example.crud.entities.enuns.OrderStatus;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//associações. popular a tabela produto-categoria
		...
		productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5)); // salva os produtos na relação com as categorias
